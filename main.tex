...
\supervisor[mailto:name@host.pt]{Jonh \textsc{Doe}} % Your supervisor's name \supname \supnamenolink
\cosupervisor[mailto:name@host.pt]{Jonh \textsc{Doe}} % Your supervisor's name \cosupname \cosupnamenolinkTo
% To hide the Co-Supervisor field, leave it at just \cosupervisor{}
\examiner{} % Your examiner's name \examname
\degree{Master of Science} % Your degree name \degreename 
\authors[mailto:jose.sa@fc.up.pt]{Jonh \textsc{Doe}} % Your name \authornames \authornamesnolink
...
\FACULTY[http://www.facultyurl.pt]{FACULTY} % Your faculty's name in capitals \FACNAME \FACNAMEnolink         
