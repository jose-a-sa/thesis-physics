...
\graphicspath{{Pictures/},{Logos/}} % Specifies the directory where pictures are stored
...
\thesistitle[Header title]{Very long long long long long long long long%
 long long long long long long long a and complete title} % Thesis title
...
\startbibliography[part]{Bibliography} % configures TOC entries and headers
% \startbibliography[chapter|part]{<name of bib chapter>} 
